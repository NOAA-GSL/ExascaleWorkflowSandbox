program calculatePi
  ...
  if (worldRank == 0) then
    ...
    write(*,"(A,I2,A,I2,A,I2.2)") "Start Time = ", timeValues(1), ":", timeValues(2), ":", timeValues(3), ":", timeValues(5), ":", timeValues(6), ":", timeValues(7)
  end if
  ...
  if (worldRank == 0) then
    call date_and_time(VALUES=timeValues)
    write(*,"(A,I2,A,I2,A,I2.2)") "End Time = ", timeValues(1), ":", timeValues(2), ":", timeValues(3), ":", timeValues(5), ":", timeValues(6), ":", timeValues(7)
  end if
